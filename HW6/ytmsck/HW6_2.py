...
def figure_square():
    figure_number = int(input("Enter are of what figure you want to calculate.\n"
    ...
    if figure_number == 1:
        ...
        #     first_side = input('Enter lenght of the first side: ')
        #     second_side = input('Enter lenght of the second side: ')
        #     print('Square of rectangle is: ',first_side * second_side)
        # rectangle_square()
    # else:
    #     return ("A")
...
# def figure_square():
#     figure_number = input("Enter are of what figure you want to calculate.\n"
#         "Print 1 for rectangle, 2 for triangle and 3 for circle: ")
#     if figure_number == 1:
#         def rectangle_square(first_side,second_side):
#             first_side = input('Enter lenght of the first side: ')
